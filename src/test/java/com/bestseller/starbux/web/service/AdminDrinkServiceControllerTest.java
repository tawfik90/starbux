...
@WebMvcTest(AdminDrinkServiceController.class)
public class AdminDrinkServiceControllerTest {
    ...
    public void add_shouldReturnHttpStatusOk () throws Exception {
        ...
        given(drinkService.add(itemRequest)).willReturn(new Drink(itemRequest.getName(), itemRequest.getPrice(), 1));

        MockHttpServletResponse response = mvc.perform(post("/admin/drinks")
    ...
    public void update_shouldReturnHttpStatusOk () throws Exception {
        ...
        MockHttpServletResponse response = mvc.perform(put("/admin/drinks/{id}", id)
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON)
                .content(itemRequestJacksonTester.write(itemRequest).getJson()))
                .andReturn()
    ...
    public void delete_shouldHttpStatusOk() throws Exception {
        ...
        MockHttpServletResponse response = mvc.perform(delete("/admin/drinks/{id}", id)
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON))
                .andReturn()
                .getResponse();
